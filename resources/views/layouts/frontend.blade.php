...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('shop.deals') }}">Deals</a>
                        </li>
                    </ul>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="header-icons d-flex align-items-center">
                            @auth
                                <a href="{{ route('dashboard.index') }}" class="nav-link"><i class="bi bi-person-circle"></i></a>
                            @else
    ...
    <footer class="footer text-muted pt-5 pb-4 mt-5">
        <div class="container text-center text-md-start">
            <div class="row">
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                    ...
                    @auth
                        <p><a href="{{ route('dashboard.index') }}" class="text-reset">Your Account</a></p>
                    @else
                    ...
                    <p><a href="{{ route('page.show', 'about-us') }}" class="text-reset">About Us</a></p>
                </div>
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
            &copy; 2023 Copyright:
            <a class="text-reset fw-bold" href="{{ route('home') }}">Techmall.pk</a>
        </div>
    </footer>
