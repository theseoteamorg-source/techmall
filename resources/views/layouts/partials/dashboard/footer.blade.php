                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a href="{{ route('shop.home') }}" class="mb-15"><img src="{{ asset('imgs/theme/logo.svg') }}" alt="logo" /></a>
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{ asset('imgs/theme/icons/icon-email-2.svg') }}" alt="" /><strong>Email:</strong><span><a href="#" class="__cf_email__" data-cfemail="5023313c35101e3523247e333f3d">[email&#160;protected]</a></span></li>
